    ...
    <div className="flex flex-col gap-5 w-full">
      ...
      {hide && (
        <div className="flex flex-row flex-wrap gap-1 md:gap-5 ">
          ...
          <div className="flex w-full items-center justify-between md:flex-col md:w-fit">
            <span className="text-sm lighttext">Third party Account</span>
            <img
              src="https://assets.staticimg.com/ucenter-web/1.5.17/svg/google.7b3612cf.svg"
              alt=""
      ...
      <div className="flex flex-wrap justify-between gap-5 ">
        <div className="flex flex-col gap-5 lg:w-[50%] w-full">
          ...
          <div className="w-full bg2nd rounded-xl p-6 ">
            ...
            <div className="flex gap-4 mb-4 border-b border-gray-700 pb-2">
              <button className="lighttext hover: transition">Favorites</button>
        ...
        <div className="flex flex-col gap-5 lg:w-[40%] w-full">
          ...
          {/* scan to download */}
          <div className=" text-[18px] flex flex-col gap-3  rounded-xl p-5 shadow-md background">
            ...
            <div className="relative flex flex-row items-center gap-2 group border border-[#0000007c] py-2 px-4 rounded-full w-fit cursor-pointer" onMouseEnter={()=>setQr(true)} onMouseLeave={()=>setQr(false)} onClick={()=>setQr(!qr)} >
              ...
              <div className={`absolute -top-[155px] left-0 transform transition-all duration-300 origin-bottom  ${qr?"opacity-100  ":"opacity-0 h-0"}`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                ...
                class="bi bi-qr-code-scan"
                viewBox="0 0 16 16"
                className={`${qr?"h-[150px]":"hidden"}  w-[150px] p-4 rounded-md bg-[#7e7d7d]`}
              >
                <path d="M0 .5A.5.5 0 0 1 .5 0h3a.5.5 0 0 1 0 1H1v2.5a.5.5 0 0 1-1 0zm12 0a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0V1h-2.5a.5.5 0 0 1-.5-.5M.5 12a.5.5 0 0 1 .5.5V15h2.5a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5v-3a.5.5 0 0 1 .5-.5m15 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1 0-1H15v-2.5a.5.5 0 0 1 .5-.5M4 4h1v1H4z" />
                <path d="M7 2H2v5h5zM3 3h3v3H3zm2 8H4v1h1z" />
                <path d="M7 9H2v5h5zm-4 1h3v3H3zm8-6h1v1h-1z" />
