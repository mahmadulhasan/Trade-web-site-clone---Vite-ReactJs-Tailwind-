...
const Login = () => {
  ...
  return (
    <div className=" m-0 p-0 min-h-screen w-full flex flex-col">
      ...
      {/* Main section */}
      <div className="flex flex-row  min-h-[70vh]  w-full items-center justify-center">
        {/* Left: Form */}
        <div className="flex flex-col gap-7.5 lg:w-1/2 w-full  px-10 max-w-[400px] lg:pt-30">
          <span className="text-[30px]  font-bold whitespace-nowrap z-10">
            Sign in to K-Exchange
          </span>
          ...
          <div className="relative text-lg font-semibold">
            <div className="flex flex-row gap-2 justify-between w-full ">
              <span
                className={`hover:font-bold cursor-pointer text-center w-1/3 ${
                  slot === 1 ? "" : "lighttext"
                }`}
                onClick={() => {
                  setSlot(1);
              ...
              <span
                className={`hover:font-bold cursor-pointer text-center w-1/3 whitespace-nowrap ${
                  slot === 3 ? "" : "lighttext"
                }`}
                onClick={() => {
                  setSlot(3);
            ...
            <div
              className="absolute h-[2px] primarycolorbg w-1/3 transform transition-all duration-300"
              style={{ left: `${(slot - 1) * (100 / 3)}%` }}
            ></div>
          </div>
          ...
          <div>
            ...
            {slot === 2 && (
              <div className="flex flex-col gap-4">
                <span className="lighttext">Mobile</span>
          ...
          <div className="flex items-center gap-0 w-full my-4">
            <div className="flex-1 h-[2px] bg2nd"></div>
          ...
          <div className="text-center">
            <a href="/signup" className="primarycolor">
              Create a K-Exchange account
            </a>
          </div>
        </div>

        {/* Right: image */}
        <div className="lg:w-1/2 w-full hidden md:flex  min-h-[70vh] items-center justify-center">
          <img src="https://kaanch.com/static/media/benefit.0500b7d48f92ff53857c.png" alt=""  className="w-full h-full  "/>
        </div>
      </div>
    </div>
  );
